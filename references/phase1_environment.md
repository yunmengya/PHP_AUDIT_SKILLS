...
Spawn two Agents simultaneously (background mode):
  ...
  Agent(name="env-detective", team_name="php-audit-skills", run_in_background=true, mode="bypassPermissions", subagent_type="general-purpose")
    → prompt: Task #1 instructions + teams/team1/env_detective.md + shared resources + TARGET_PATH + WORK_DIR

  Agent(name="schema-reconstructor", team_name="php-audit-skills", run_in_background=true, mode="bypassPermissions", subagent_type="general-purpose")
    → prompt: Task #2 instructions + teams/team1/schema_reconstructor.md + shared resources + TARGET_PATH + WORK_DIR

Wait for both to complete
── Serial Step ──

  Agent(name="docker-builder", team_name="php-audit-skills", foreground, mode="bypassPermissions", subagent_type="general-purpose")
...
Complete
  Agent(name="quality-checker-1", team_name="php-audit-skills", foreground, mode="bypassPermissions", subagent_type="general-purpose")
